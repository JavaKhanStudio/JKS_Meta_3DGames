...
public class TestLightBlowTerrainSystemTextureColor extends SimpleApplication {
    ...
    public static void main(final String[] args) {
        final TestLightBlowTerrainSystemTextureColor app = new TestLightBlowTerrainSystemTextureColor();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        final Material mat = this.assetManager
                .loadMaterial("TestMaterials/LightBlow/Terrain_System/Terrain_System_Texture.j3m");
