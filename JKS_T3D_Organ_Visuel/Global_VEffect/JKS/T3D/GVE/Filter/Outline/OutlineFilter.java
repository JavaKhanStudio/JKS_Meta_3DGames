package JKS.T3D.GVE.Filter.Outline;
...
public class OutlineFilter extends Filter 
{
	...
	public final static String matPath = "JavaKhan/MatBank/Static/Outline/" ; 
	...
	protected void initFilter(AssetManager assetManager, RenderManager renderManager, ViewPort vp, int w, int h) {
		MaterialDef matDef = (MaterialDef) assetManager.loadAsset(matPath + "Outline.j3md");
