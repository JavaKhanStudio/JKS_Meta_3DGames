...
public class TA_Tourniquet extends Node {
	...
	public TA_Tourniquet(Spatial ref, float rayon, PhysicsSpace Space)
	{
	...
	private Spatial buildBox(float x, float y, float z) 
	{
		...
		Material material = new Material(GVars_Soul_Model.getApp().getAssetManager(), "Common/MatDefs/Misc/Unshaded.j3md");
        material.setTexture("ColorMap", GVars_Soul_Model.getApp().getAssetManager().loadTexture("Interface/Logo/Monkey.jpg"));
