...
public class TgGui_Model_MutiSelectionSection extends Panel
{
	...
	public TgGui_Model_MutiSelectionSection(int colum,int row ,Vector2f size,ElementManager screen) 
	{
		super(screen);
