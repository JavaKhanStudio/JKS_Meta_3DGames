...
public class CleanTextLabel extends Label
{

	static final float multSize = 2.0f ;
	
	
	public CleanTextLabel(ElementManager screen, Vector2f position, Vector2f dimensions) 
	{
	...
	public CleanTextLabel(Vector2f position, float sizeY,String text)
	{this(GVars_Soul_Model.screen,position,sizeY,text) ;}
	
	public CleanTextLabel(ElementManager screen, 
							Vector2f position, 
							float sizeY,
							String text) 
	{
