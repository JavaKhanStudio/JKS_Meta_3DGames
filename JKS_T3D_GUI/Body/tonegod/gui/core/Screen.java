...
public class Screen implements ElementManager, Control, RawInputListener 
{
    ...
    private Map<String, Element> allElements = new LinkedHashMap<String, Element>();
    private Map<String, SubScreen> subscreens = new HashMap<String, SubScreen>();
    ...
    private Map<Integer, Vector2f> elementOffsets = new HashMap<Integer, Vector2f>();
    private Map<Integer, Element> contactElements = new HashMap<Integer, Element>();
    private Map<Integer, Element> eventElements = new HashMap<Integer, Element>();
    private Map<Integer, Borders> eventElementResizeDirections = new HashMap<Integer, Borders>();
    ...
    private Map<String, AnimLayer> layers = new LinkedHashMap<String, AnimLayer>();
    ...
    public void addElement(Element element) {
        ...
        if (getElementById(element.getUID()) != null) {
            ...
            allElements.put(element.getUID(), element);
    ...
    {
        allElements.remove(element.getUID());
...
//        }
    ...
    public Element getElementById(String UID) 
    {
        ...
        {ret = allElements.get(UID);} 
        else 
        {
            for (Element el : allElements.values()) 
            {
     ...
     */
    @Override
    public void setInFront(Element topMost) 
    {
                    ...
                    case 0:
                        ...
                        if (eventElement != null) {
                            if (eventElement.getAbsoluteParent().getEffectZOrder()) {
                                setInFront(eventElement.getAbsoluteParent());
                            }
                            if (eventElement.getResetKeyboardFocus()) {
    ...
    private void androidTouchDownEvent(TouchEvent evt) {
        ...
        if (target != null) {
            ...
            if (target.getAbsoluteParent().getEffectZOrder()) {
                setInFront(target.getAbsoluteParent());
            }
            if (target.getResetKeyboardFocus()) {
...
//	@Override
    ...
    public Control cloneForSpatial(Spatial spatial) 
    {
        ...
        screen.allElements.putAll(this.allElements);
        return screen;
    }
