 ...
 * @author t0neg0d
 */
public abstract class Button extends Element implements Control, MouseButtonListener, MouseFocusListener, KeyboardListener, TabFocusListener, ButtonInterface 
{
    ...
    public void setStyles(String styleName) {
        ...
        //	defaultSize = style.getVector2f(â€œdefaultSizeâ€�);
